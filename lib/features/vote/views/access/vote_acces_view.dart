...
class _VoteCastingViewState extends State<VoteCastingView> {
  ...
  Widget build(BuildContext context) {
    ...
    // Vue normale pour voter (même après deadline pour voir son choix)
    return Scaffold(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Message si le vote est terminé
                    if (!canVote && widget.vote.isFinished)
                      Container(
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                "Ce vote est terminé. Vous ne pouvez plus modifier votre choix.",
                                style: TextStyle(
                                  fontSize: 13,
